...
const randomStringSource = "abcefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890_+"
...
func (t *Tools) ReadJSON(w http.ResponseWriter, r *http.Request, data any) error {
	...
	if err != nil {
		...
		case err.Error() == "http: request body too large":
			return fmt.Errorf("body not be large than %d bytes", maxBytes)
	...
	if err != io.EOF {
		return errors.New("error must contain only one json value")
	}
	return nil
}
